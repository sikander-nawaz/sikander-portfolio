    ...
    <section className="relative min-h-screen flex items-center overflow-hidden px-6 pt-24 pb-16">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col order-2 lg:order-1">
          ...
          <motion.div
            {...fadeUp(0.1)}
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-[#C8A257]/20 bg-[#C8A257]/[0.06] mb-8 w-fit"
          >
          ...
          <motion.p
            {...fadeUp(0.3)}
            className="text-zinc-400 font-outfit font-light max-w-[500px] mb-8 leading-relaxed text-base lg:text-lg"
          >
            Building scalable web applications and empowering the next
            generation of developers through mentorship and teaching — based in{" "}
            <span className="text-[#E2C792] font-medium">
              Faisalabad, Pakistan
            </span>
            .
          </motion.p>
          ...
          <motion.div
            {...fadeUp(0.6)}
            className="flex items-center gap-6 mt-8 pt-6 border-t border-white/[0.05]"
          >
            {[
              {
                label: "GitHub",
              ...
              {
                label: "LinkedIn",
                href: "https://linkedin.com/in/sikander-nawaz",
                icon: (
                  <svg
                    width="14"
                    height="14"
              ...
              {
                label: "LeetCode",
                href: "https://leetcode.com/sikander_09",
                icon: <Code2 size={14} />,
              },
            ].map((link) => (
              <a
        ...
        >
          <div className="relative w-[280px] h-[360px] sm:w-[340px] sm:h-[430px] lg:w-[400px] lg:h-[510px]">
            ...
            <div
              ...
              style={{
                boxShadow:
                  "0 0 80px rgba(200,162,87,0.06), 0 0 160px rgba(200,162,87,0.03)",
                borderRadius: "20px",
              }}
            />
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(160deg, rgba(200,162,87,0.06) 0%, rgba(226,199,146,0.04) 60%, transparent 100%)",
                  mixBlendMode: "screen",
                }}
              />
